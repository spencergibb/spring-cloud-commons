 ...
 */
@SpringBootTest()
@ActiveProfiles("featureprops")
public class FeaturePropertiesProviderTests {
	...
	static class TestConfiguration {
		...
		@Bean
		FeaturePropertiesProvider environmentFeatureProvider(FeatureProperties featureProperties) {
			return new FeaturePropertiesProvider(featureProperties);
		}
